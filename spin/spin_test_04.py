...
# =================================================================
# [3] Step 2: DRL 생성기 (movec + ori=2 완벽 융합)
# =================================================================
def generate_scan_drl():
    ...
    for i in range(TOTAL_LAYERS):
        ...
        # 💡 [핵심 수정] 6번 조인트 한계(Wind-up) 완벽 방어 로직!
        if layer_num % 2 == 1:
            # 홀수 층 (시계방향 CW): 180도에서 시작해 -180도로 도착.
            angles = [180.0, 90.0, 0.0, -90.0, -180.0] 
        else:
            # 짝수 층 (반시계방향 CCW): 방금 끝난 -180도에서 시작해 다시 180도로 관절을 풀면서 돌아감!
            angles = [-180.0, -90.0, 0.0, 90.0, 180.0] 
        ...
        # 💡 유저님이 원하신 2번 나눠서 도는 로직 (ori=2 적용)
