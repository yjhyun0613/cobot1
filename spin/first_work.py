...
class M0609ConveyorPickPlaceToolNode(Node):
    def __init__(self):
        ...
        self.inspection_above_posx = [426.5, 135.72, 52.88, 104.72, -177.01, 105.27]
        self.inspection_place_posx = [426.5, 135.72, 12.88, 104.72, -177.01, 105.27]
    ...
    def run_sequence(self):
        tasks = [
            ("movel", "컨베이어 위 좌표 이동", self.conveyor_above_pick_posx),
            ("gripper", "그리퍼 열기", "open"),
            ...
            ("movel", "압입 지점 50mm 상부 이동", self.pressing_above_posx),
            ("movel", "그리퍼 위 장소 이동", self.tool_safe_posx),
