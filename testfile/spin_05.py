...
def main(args=None):
    ...
    try:
        ...
        # ==========================================================
        scan_drl_code = """
# 💡 순응 제어 설정 (플라스틱 반구 파손 방지)
# 강성(Stiffness)을 500으로 낮게 설정하여 부드럽게 반응하게 함
...
"""
        ...
        # ==========================================================
        # [Step 5] 대기 자세로 복귀 (기록 종료 후 실행하여 궤적에 남지 않음)
        # ==========================================================
        print("대기 자세로 복귀합니다.")
